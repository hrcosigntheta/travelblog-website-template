...
export const malapascua: Destination = {
  ...
  imageAlt: 'Hero image of Malapascua Island in Cebu, Philippines',
  rating: 4.7,
  ...
  images: [
    ...
    { src: '/images/destinations/malapascua-3.jpg', alt: 'Malapascua Island photography - Shot 3' },
    { src: '/images/destinations/malapascua-4.jpg', alt: 'Malapascua Island photography - Shot 4' },
  ],
  coordinates: {
    lat: 11.3323,
    lng: 124.1159,
