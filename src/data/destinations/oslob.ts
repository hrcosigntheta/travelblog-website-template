...
export const oslob: Destination = {
  ...
  imageAlt: 'Hero image of Oslob in Cebu, Philippines',
  rating: 4.5,
  ...
  images: [
    ...
    { src: '/images/destinations/oslob-3.jpg', alt: 'Oslob photography - Shot 3' },
    { src: '/images/destinations/oslob-4.jpg', alt: 'Oslob photography - Shot 4' },
  ],
  coordinates: {
    lat: 9.4607,
    lng: 123.3807,
