...
export const kawasanFalls: Destination = {
  ...
  imageAlt: 'Hero image of Kawasan Falls in Cebu, Philippines',
  rating: 4.9,
  ...
  images: [
    ...
    { src: '/images/destinations/kawasan-falls-3.jpg', alt: 'Kawasan Falls photography - Shot 3' },
    { src: '/images/destinations/kawasan-falls-4.jpg', alt: 'Kawasan Falls photography - Shot 4' },
  ],
  coordinates: {
    lat: 9.8035,
    lng: 123.3745,
