...
export const batanes: Destination = {
  ...
  imageAlt: 'Hero image of Batanes Islands in Cagayan Valley, Philippines',
  rating: 4.9,
  ...
  images: [
    ...
    { src: '/images/destinations/batanes-3.jpg', alt: 'Batanes Islands photography - Shot 3' },
    { src: '/images/destinations/batanes-4.jpg', alt: 'Batanes Islands photography - Shot 4' },
  ],
  coordinates: {
    lat: 20.4485,
    lng: 121.9708,
